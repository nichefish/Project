...
<c:forEach items="${comments}" var="comment"  varStatus = "status">
   <tr align="center" valign="middle" bordercolor="#333333"
      ...
      <td style="font-family:Tahoma;font-size:10pt;">
         <div align="center">         
         <a href="commentDetail?num=${comment.commentNo}">${comment.commentSubject}</a>
         </div>
      </td>
      ...
      <td style="font-family:Tahoma;font-size:10pt;">
         <div align="center"><fmt:formatDate value="${comment.regDate }" type="date" pattern="yyyy-MM-dd"/> </div>
      </td>
   </tr>
</c:forEach>
