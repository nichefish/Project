...
<form:form action="memberJoinAction" name="frm" id="frm" method="post" commandName="memberCommand">
	<!-- memberCommand 커맨드 객체를 받아오겠다는 거임.. 이렇게 객체값 받아올때만 요 form:form 쓰면 된다.. -->
	...
	<table width="600" align="center" border=1 >
	 	...
	 	<tr>
	 		<td width="200">성별</td>
	 		<td width="400">
	 			남자 : <form:radiobutton path="userGender" value="M" id="userGender" checked="checked" />
	 			여자 : <form:radiobutton path="userGender" value="F" id="userGender" />
	 		</td>
	 	</tr>
	 	<tr>
		...
		<tr>
			<td width = 200 ><b>* 사용자 연락처2 </b></td>
			<td width = 400 >
				<form:input path="userPh2" id = "userPh2" size = "30" maxlength="28" />
			</td>
		</tr>
		<tr>
			<td colspan = 2>
