...
<body>
	<form action="goodsModifyPro.gd" method="post" enctype="multipart/form-data" >
		<table border="1">
			...
			<tr>
				<td>상품가격</td>
				<td><input type="text" name="goodsPrice" id="goodsPrice" value="${goods.goodsPrice}"/></td>
			</tr>
			<tr>
				<td>입고수량</td>
				<td><input type="text" name="goodsQty" id="goodsQty" value="${goods.goodsQty}"/></td>
			</tr>
			<tr>
				<td>상품 설명</td>
				<td><textarea rows="13" cols="56" name="goodsContent" id="goodsContent">${goods.goodsContent}</textarea></td>
			</tr>
			<tr>
				<td>파일</td>
				<td>${goods.goodsImage}
		...
		<input type="text" name="goodsSeq" id="goodsSeq" value="${goods.goodsSeq}"/>
	</form>
</body>
</html>