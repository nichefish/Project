...
public class CommentListRepository {
	...
	private final String namespace = "commentDynamicMapper";
	...
	public MemberDTO commentUser(Long commentNo) {		// 1대 1..
		String statement = namespace + ".commentAssociation";
		return sqlSession.selectOne(statement, commentNo);
	}

	public CommentRepliesDTO commentReplies(Long commentNo) {		// 1대 다..
