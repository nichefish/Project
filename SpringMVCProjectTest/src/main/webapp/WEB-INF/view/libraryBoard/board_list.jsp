	...
	<table width=50% border="0" cellpadding="0" cellspacing="0">
		...
		<tr align="center" valign="middle" bordercolor="#333333" onmouseover="this.style.backgroundColor='F8F8F8'" onmouseout="this.style.backgroundColor=''">
			...
			<td style="font-family:Tahoma;font-size:10pt;">
				<div align="left">▶&nbsp;<a href="./boardDetail?num=${board.boardNum}">${board.boardSubject}</a></div>
			</td>
			<td style="font-family:Tahoma;font-size:10pt;">
				<div align="center">${board.boardName}</div>
			</td>
			<td style="font-family:Tahoma;font-size:10pt;">
				<div align="center"><fmt:formatDate value="${board.boardDate}" type="date" pattern="yyyy년 MM월 dd일"/></div>
			</td>	
			<td style="font-family:Tahoma;font-size:10pt;">
