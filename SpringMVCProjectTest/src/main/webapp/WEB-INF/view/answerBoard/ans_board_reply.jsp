...
<body>
	<form action="./answerBoardReplyAction.ab" method="post" name="boardform">
		...
		<input type="hidden" name="BOARD_RE_REF" value="${board.boardReRef}">
		<input type="hidden" name="BOARD_RE_LEV" value="${board.boardReLev}">
		<input type="hidden" name="BOARD_RE_SEQ" value="${board.boardReSeq}">
			...
			<tr>
				...
				<td>
					<input name="BOARD_SUBJECT" type="text" size="50" 
						maxlength="100" value="Re: ${board.boardSubject}"/>
				</td>
			</tr>
			<tr>
