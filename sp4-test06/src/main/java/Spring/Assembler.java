...
public class Assembler {		// 객체조립기...
	...
	public Assembler() {
		...
		this.mrs = new MemberRegisterService(memberDAO);	// 생성자
		this.listPrint = new MemberListPrinter();		// setter
		this.changePwSvc = new ChangePasswordService();		// setter
		this.infoPrinter = new MemberInfoPrinter(memberDAO, printer);		// 생성자
	}
